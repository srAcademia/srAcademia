...
class ExerciciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercicio" do
    assert_difference('Exercicio.count') do
      post exercicios_url, params: { exercicio: { descricao: @exercicio.descricao, grupo_muscular: @exercicio.grupo_muscular, nome: @exercicio.nome } }
    end
  ...
  test "should update exercicio" do
    patch exercicio_url(@exercicio), params: { exercicio: { descricao: @exercicio.descricao, grupo_muscular: @exercicio.grupo_muscular, nome: @exercicio.nome } }
